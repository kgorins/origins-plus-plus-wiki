...
## Anomaly
Once an ancient star, now unstable energy.

## Artificial construct
Constructs are a combination of simple redstone components and complicated machinery to make a functional living being.

## Automaton
These machines were built by a race long lost to time. Some were kept in a capsule that eroded quite recently. They now wander this earth without the fear of death.

## Beaver
Beavers are large, semi-aquatic rodents in the genus 'castor' native to the temperate northern hemisphere.

## Bedrockean
You are bedrock.

## Binturong
A binturong is a bear cat of the trees.
